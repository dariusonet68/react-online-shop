export const mockProducts = {
  products: [
    ...
    {
      id: 125,
      title: 'Classic cotton T-shirt (black)',
      price: 750,
      description:
    ...
    },
    {
      ...
      title: 'pen',
      price: 50,
      description: 'pen is written',
      images: [
        'https://spn-sta.spinny.com/blog/20221004191046/Hyundai-Venue-2022.jpg?',
      ],
      ...
      category: {
        ...
        name: 'Iphone12ProMax',
        image:
          'https://btech.com/media/catalog/product/i/p/iphone-12-pro-max-blue-hero_1.png?width=464&store=ar&image-type=image',
      },
    },
    {
      id: 161,
      ...
      description: 'car',
      images: [
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRA3w2AAi_RpK2Pmxx_Sr4HA1lWnT-5mTWTdw&s',
      ],
    ...
    },
    {
      ...
      description: 'cars',
      images: [
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxpMQ0UjuN63hb9KkHPO4Cdvr0Ea_KnucCbw&s',
      ],
    ...
    },
    {
      ...
      title: 'car wallpaper',
      price: 5500,
      description: 'wall walpaper',
      images: [
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdHtqioLW3qAdaZCALAUcebNjUHLGPovCJ4A&s',
      ],
    ...
    },
    {
      ...
      title: 'qspiders',
      price: 25000,
      description: 'this is a product from qspiders',
      images: [
    ...
    {
      id: 167,
      title: 'jspider product',
      price: 2000,
      description: 'This is a product from Jspider',
      images: [
        'https://plus.unsplash.com/premium_photo-1670076513880-f58e3c377903?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZnVybml0dXJlfGVufDB8fDB8fHww',
      ],
    ...
    {
      id: 169,
      title: 'my product 2024',
      price: 50000,
      description: 'this is a product created by spread operator',
      images: [
        'https://plus.unsplash.com/premium_photo-1670076513880-f58e3c377903?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZnVybml0dXJlfGVufDB8fDB8fHww',
      ],
    ...
    },
    {
      ...
      images: [
        'https://images.unsplash.com/photo-1528825871115-3581a5387919?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8YmFuYW5hfGVufDB8fDB8fHww',
      ],
    ...
    },
    {
      ...
      title: 'Asif',
      price: 200,
      description: 'A sdsdsd description',
      images: ['https://placeimg.com/640/480/any'],
      category: {
        id: 2,
        name: 'Electronics',
    ...
    },
    {
      ...
      images: [
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtlnCdppn2vwxSKGHfgh_kuJ111-023hSlqw&s',
      ],
      category: {
        id: 2,
        name: 'Electronics',
